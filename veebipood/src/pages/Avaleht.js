...
//tavaline sinine - meie tehtud muutuja. useState vasakpool, useRef muutuja
...
//       JS koodiblokk: funktsiooni koodiblokk, if/else koodiblokk. objekti hoidmiseks {nimi: "Coca", hind: 5, pilt: ""}
...
// Kui kutsun välja useState funktiooni onClick kaudu (uuendaXX, muudaX),
//          siis pean saatma midagi sulguse sees kaasa -->sellest saab muutuja uus väärtus

// Kui kutsun funktsiooni välja, siis midagi kaasa saatma ei pea
// siis võn {() => nulli()} teha hoopis lihtsalt {nulli}
